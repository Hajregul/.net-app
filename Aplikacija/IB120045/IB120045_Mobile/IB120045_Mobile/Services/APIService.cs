...
namespace IB120045_Mobile.Services
{
...
#if DEBUG
        private string _apiUrl = "http://localhost:55393/api";
#endif
#if RELEASE
    ...
    public async Task<T> Get<T>(object search)
        ...
        public async Task<T> GetById<T>(string id)
        {
            ...
            public async Task<T> GetByAktivnostId<T>(string id)
        {
        ...
        public async Task<T> GetByIdAktivnostID<T>(int korisnikID, int aktivnostID)
        {
            try
            {
                var url = $"{_apiUrl}/{_route}/{korisnikID}/{aktivnostID}";
